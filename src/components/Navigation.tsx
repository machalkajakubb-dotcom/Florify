...
const NAV_ITEMS = [
  ...
  { href: "/game",     labelKey: "nav_game",     icon: GameIcon },
...
export function Navigation() {
  ...
  return (
    <nav
      className="fixed bottom-0 left-0 right-0 z-50 bg-white/95 dark:bg-gray-900/95 backdrop-blur-md border-t border-stone-100 dark:border-gray-800 grid grid-cols-7"
